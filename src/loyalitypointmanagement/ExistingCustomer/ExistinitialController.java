...
import loyalitypointmanagement.lostmycard.*;
 ...
 * @author parwez
 */
public class ExistinitialController implements Initializable {
...
//                }
    ...
    private void Back_Dashboadrd(MouseEvent event) {
        try {
            ...
            Logger.getLogger(ExistinitialController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
