...
import loyalitypointmanagement.checkinout.*;
 ...
 * @author partha
 */
public class CheckInOutController_Backup implements Initializable {
...
//                    String response = new AppHelper().performPostCall(CUSTOMER_DETAILS, params);
//                    JSONObject jobject = new JSONObject(response);
//                    if (jobject.getString("msg").equals("1")) {
//                        name = jobject.getString("fullname");
//                        address = jobject.getString("present_address");
//                        phone = jobject.getString("phone_no");
//                        point = jobject.getString("points");
//
...
//        }
    ...
    private void BackDashBoard(MouseEvent event) {
        try {
            ...
            Logger.getLogger(CheckInOutController_Backup.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
